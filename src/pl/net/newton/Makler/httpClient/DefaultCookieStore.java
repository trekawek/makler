/*
 * $HeadURL:
 * http://svn.apache.org/repos/asf/httpcomponents/httpclient/trunk/module-client/src/main/java/org/apache
 * /http/impl/client/BasicCookieStore.java $ $Revision: 653041 $ $Date: 2008-05-03 03:39:28 -0700 (Sat, 03 May
 * 2008) $
 * 
 * ====================================================================
 * 
...
public class DefaultCookieStore implements CookieStore {
	...
	/**
	 * Adds an {@link Cookie HTTP cookie}, replacing any existing equivalent cookies. If the given cookie has
	...
	/**
	 * Adds an array of {@link Cookie HTTP cookies}. Cookies are added individually and in the given array
	 * order. If any of the given cookies has already expired it will not be added, but existing values will
	 * still be removed.
	 * 
